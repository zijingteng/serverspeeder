...
# 锐速破解版安装方法：
    wget -N --no-check-certificate https://github.com/zijingteng/serverspeeder/raw/master/serverspeeder.sh && bash serverspeeder.sh
# 锐速破解版卸载方法：
...
目前只支持CentOS，ubuntu和debian。如果有其他系统支持，可以到[91yun.org](http://www.91yun.org/serverspeeder91yun)手动下载其他系统的安装包
